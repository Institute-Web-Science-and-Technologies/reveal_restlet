...
public class LocationCrawlerBolt extends BaseRichBolt {
    ...
    private static Map<String, String> dereferenceLocation(String key) {
        ...
        try (QueryExecution qexec = QueryExecutionFactory.sparqlService("http://dbpedia.org/sparql", query)) {
            ...
            if (results.hasNext()) {
                ...
                resultMap.put("location", key);
                resultMap.put("lat", result.get("?lat").toString());
                resultMap.put("long", result.get("?long").toString());
                return resultMap;
            } else {
                return null;
            }
    ...
    /**
     * Execute received Tuple. In this case we will simply print received
     * output.
     *
    ...
    public void execute(Tuple input) {
        ...
        ArrayList<Map<String, String>> relatedLocations = new ArrayList<>();
                ...
                if (dbPediaUri != null) {
                    ...
                    for (Entry<String, ArrayList<String>> e : possibleLocations.entrySet()) {
                        if (checkCandidateBasedOnProperties(e.getValue())) {
                            Map<String, String> locationWithCoordinates = dereferenceLocation(e.getKey());
    ...
    /**
     * Declare output field name (in this case it is not used because printer
     * bolt will not emit any messages to other bolts)
     *
